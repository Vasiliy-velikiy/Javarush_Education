...
public class MultiThreadingTest10_hard {
    ...
    public static int calculateHorsesFinished(List<Horse> horses) throws InterruptedException {//должен вернуть количество финишироющих лошадей
        int finishedCount = 0;
